...
export default function PhotoUploader({ addedPhotos, onChange }) {
   ...
   function setAsMainPhoto(e, filename) {
      e.preventDefault();
      const notSelectedPhotos = addedPhotos.filter(
         (photo) => photo !== filename
      );
      const starPhoto = [filename, ...notSelectedPhotos];
      onChange(starPhoto);
   }
               ...
               addedPhotos.map((link) => (
                  <div className="h-32 flex relative" key={link}>
                     ...
                     <button
                        ...
                        className=" cursor-pointer absolute bottom-0 right-2 text-white bg-black py-2 px-2 bg-opacity-50 rounded-2xl">
                        <svg
                     ...
                     <button
                        ...
                        className=" cursor-pointer absolute bottom-0 left-2 text-white bg-black py-2 px-2 bg-opacity-50 rounded-2xl">
                        {link === addedPhotos[0] && (
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
